...
## Description
In this  part of the Mini challenge, the student will learn how to simulate a DC motor using its dynamical model and visualise its output in RVIZ.
The node: “motor_sim” will be developed.
“motor_sim” Node: Simulate a DC motor using its dynamical model. The input to the model is the voltage (𝑢), and the output is the angular velocity of the motor (𝜔).
